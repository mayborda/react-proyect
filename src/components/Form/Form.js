    ...
    >
      <div className="flex flex-col items-start rounded-md p-4 shadow-md">
        ...
        <input
          ...
          required
          className={
            datos.email1 === datos.email2
              ? "w-full"
              : "w-full border-2 border-red-400"
          }
        />
        {datos.email1 === datos.email2 ? (
          <button className="flex items-center px-6 mt-4 bg-btn text-shipGray max-w-sm h-12 rounded-md mx-auto">
            Terminar Compra
          </button>
        ) : (
          <div className="flex items-center px-6 mt-4 bg-btn text-shipGray max-w-sm h-12 rounded-md mx-auto">
            Terminar Compra
          </div>
        )}
      </div>
